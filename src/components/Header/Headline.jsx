          ...
          <div className="flex items-center gap-8">
            <address className="flex items-center justify-center gap-4 not-italic">
              <span className="block py-[1.6rem]">
                <MdOutlineEmail
                  className="block h-[2.4rem] w-[2.4rem] fill-[var(--primary)]"
            ...
            <div className="flex items-center justify-center gap-4">
              <span className="block py-[1.6rem]">
                <FiClock
                  className="block h-[2.4rem] w-[2.4rem] stroke-[var(--primary)]"
                  aria-label="Clock Icon"
                />
              </span>
              <p className="headline-text">
                Mon to Sat: 9.00am - 9.00pm, Sun: 9.00am - 12.00pm
              </p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-4">
            <div className="flex items-center justify-center gap-4">
              <a
                ...
                className="px-2"
                title="Visit Sikka Cleaners on Facebook"
              >
              ...
              <a
                ...
                className="px-2"
                title="Visit Sikka Cleaners on Instagram"
              >
            ...
            <div className="flex items-center justify-center gap-4 headline-text">
              <FiPhoneCall
                className="inline-block h-[2.1rem] w-[2.1rem] stroke-[var(--primary)]"
