    ...
    <section className="section-padding">
      <div className="content-container">
        <div className="flex justify-between gap-12 tab-s:gap-8 tab:flex-col tab:gap-12">
          <div className="basis-[35%] laptop-l:flex-[0_0_40%] tab-l:flex-[0_0_40%]  tab-s:flex-[0_0_46%]">
          ...
          <div className="basis-[56.2%] laptop-l:flex-[0_0_48%] tab-l:flex-[0_0_50%] tab-s:flex-grow">
